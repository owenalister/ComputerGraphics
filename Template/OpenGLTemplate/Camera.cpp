...
CCamera::CCamera()
{
	m_position = glm::vec3(100.0f, 0.0f, 0.0f);	
...
void CCamera::Strafe(double direction)
{
	if (mode != 4)
	{
		...
		float speed = (float)(m_speed * direction*100);
